...
# Time series that's true starting on a given date, and otherwise false
def TrueFrom(dt):
    return traces.TimeSeries([[DawnOfTime, False], [dt, True]])


# Time series that's true up until a given date, and otherwise false
def TrueUntil(dt):
...
result = Not(TrueFrom('2000-01-01'))
